    ...
    <>
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        <div className="pt-6 pb-8 space-y-2 md:space-y-5">
          <h1 className="text-3xl font-comfortaa font-extrabold leading-9 tracking-tight sm:text-4xl sm:leading-10 md:text-6xl md:leading-14">
            Latest
          </h1>
                ...
                <article>
                  <div className="space-y-2 xl:grid xl:grid-cols-4 xl:space-y-0 xl:items-baseline">
                    <dl>
                      ...
                      <dd className="text-base font-medium leading-6 dark:text-marsala">
                    ...
                    <div className="space-y-5 xl:col-span-3">
                      ...
                      <div className="text-base font-medium leading-6">
                        <Link
                          href={`/blog/${slug}`}
                          className="dark:text-seafoam hover:text-marsala dark:hover:text-marsalaLight"
      ...
      {posts.length > MAX_DISPLAY && (
        <div className="flex justify-end text-base font-medium leading-6">
          <Link
            href="/blog"
            className="text-primary-500 dark:text-seafoam hover:text-marsala dark:hover:text-marsalaLight"
